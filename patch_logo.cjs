...
const newLogo = `<div className="cursor-pointer flex items-center" onClick={() => setActiveTab?.('Orders')}>
                <img src="/logo.png" alt="SRK Modular Furniture co" className="h-10 w-auto" />
              </div>`;
